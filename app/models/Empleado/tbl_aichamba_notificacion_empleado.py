...
class tbl_aichamba_notificacion_empleado(db.Model):
    ...
    aich_int_idempleador = db.Column(db.Integer, db.ForeignKey('tbl_aichamba_empleador.aich_int_idempleador'), nullable=False)
    aich_bit_activo = db.Column(db.Integer, nullable=False)


    # Agregamos las relaciones
    empleado = relationship('tbl_aichamba_empleado', foreign_keys=[aich_int_idempleado])
